...
public class UsuarioController implements ActionListener {
    ...
    public void showCrearUser() {
        ...
        this.userVista = new UsuarioVista(this.principal);
    ...
    public void showTable() {
        ...
        this.userTable = new UsuarioTable(datosTabla, columns, this.principal);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (e.getActionCommand()) {
            ...
            case "Crear":
                this.principal.UserItem.setEnabled(true);
            ...
            case "Datos":
                ...
                this.principal.ListarItem.setEnabled(true);
